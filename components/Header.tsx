...
function Header({socials}: Props) {
    return (
        <header className="sticky top-0 p-5 flex items-start justify-between  mx-auto z-20 xl:items-center">
            ...
            >
                <Link
                    href="https://drive.google.com/file/d/1nVtnlRF2Gc5YEVMvcPfRmxGJY61vry8B/view?usp=sharing"
                    target="_blank"
                >
                    <button
                        className="whitespace-nowrap md:rounded-full bg-white md:shadow transition md:border bg-opacity-0 hover:animate-pulse md:hover:animate-none text-gray-300 md:hover:bg-gray-200 md:hover:text-black py-3 px-3 space-x-2">
